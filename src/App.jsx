...
class App extends Component {
  ...
  render() {
    return (
      <React.Fragment>
        <Container>
          <h1>Peaks.js React Example</h1>

          <p>
            This is a simple example of how to use{" "}
            <a href="https://github.com/bbc/peaks.js">Peaks.js</a> in a React
            application.
          </p>

          <p>
            Audio content is copyright BBC, from the{" "}
            <a href="https://sound-effects.bbcrewind.co.uk">
              BBC Sound Effects
            </a>{" "}
            library, used under the terms of the{" "}
            <a href="https://sound-effects.bbcrewind.co.uk/licensing">
              RemArc Licence
            </a>
            .
          </p>
